...
from .config import CONFIG_CLASS, SWRConfig
from .learner import SWRLearner
...
def build(
    *,
    ...
    method_config: SWRConfig | Mapping[str, Any],
    ...
    return SWRLearner(network=network, config=config, problem=problem,
